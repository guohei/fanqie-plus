...
- For chapters, follow `.fanqie-plus/references/chapter-pipeline.md`, `.fanqie-plus/references/story-memory.md`, `.fanqie-plus/references/quality-gates.md`, and `.fanqie-plus/references/outline-anchor.md`; run `.fanqie-plus/scripts/gate_check.py`; run one Memory Commit after final; run `.fanqie-plus/scripts/fanqie_doctor.py --project-root . chapter-check --chapter N`.
